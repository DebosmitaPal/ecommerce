...
const SportsOutdoorsPage = () => {
  ...
  const products = [
    {
      ...
      description: "Professional treadmill for home workouts with speed control."
    },
    {
      id: 602,
      name: "Cycle",
    ...
    },
    {
      ...
      description: "Official size and weight football for outdoor matches."
    },
    {
      id: 604,
      name: "Dumbell",
      ...
      description: "Professional dumbell for home workouts with shoulder exercise."
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ================= PAGE CONTENT ================= */}
      <div className={`max-w-7xl mx-auto px-4 py-8 ${selectedProduct ? "blur-sm pointer-events-none select-none" : ""}`}>
        <div className="grid lg:grid-cols-4 gap-8">

          {/* ===== SIDEBAR ===== */}
          <aside className="bg-white p-6 rounded-xl shadow">
            <h2 className="font-bold mb-4">Sports & Outdoors</h2>
            ...
            {sportsCategories.map(c => {
              ...
              return (
                <button
                  ...
                  `}
                >
                  <Icon size={18} className={isActive ? "text-white" : "text-orange-500"} />
          ...
          <div className="bg-white max-w-4xl w-full p-6 rounded-xl relative">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex gap-3 mt-6">
                  <button onClick={() => addToCart(selectedProduct, 1)} className="flex-1 bg-orange-500 text-white py-3 rounded">
                    Add to Cart
                  </button>
                  <button onClick={() => addToWishlist(selectedProduct)} className="border px-4 rounded">
                    <Heart />
                  </button>
                </div>
              </div>
            ...
            <div className="mt-8 border-t pt-4">
              ...
              <div className="space-y-3">
                <div className="bg-gray-100 p-3 rounded">⭐⭐⭐⭐⭐ Excellent quality and build</div>
                <div className="bg-gray-100 p-3 rounded">⭐⭐⭐⭐ Great for home workouts</div>
              </div>
            </div>
